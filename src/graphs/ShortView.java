 ...
 */
//tHIS CLASS HAS THE SAME FUNCTION WITH THE VIEW CLASS.
//It draws the shortest path.
//It doesnt show the weight of the edges.
package graphs;
 ...
 * @author ozan
 */
public class ShortView extends javax.swing.JPanel
{
   private WeightedGraph<? extends Displayable> graph;
	
	//Constructor
   public ShortView (WeightedGraph<? extends Displayable> graph)
	{
	  this.graph = graph;
		 ...
		 for(int j = 0; j < neighbors.size(); j++)
		 {
		   ...
		   int v = neighbors.get(j);
			...
			int y2 = graph.getVertex(v).getY();
                        ...
                        int halfX = (centerX + x2)/2;
                        int halfY = (centerY + y2)/2;
